...
class MainFrame(wx.Frame):
    ...
    def init_UI(self):
        ...
        fitem1 = self.fileMenu.Append(wx.ID_EXIT, 'Quit', 'Quit Application')
        fitem2 = self.fileMenu.Append(1, 'Save', 'Save Image')
        fitem3 = self.fileMenu.Append(2, 'clear', 'clear')
        fitem4 = self.fileMenu.Append(3, 'Screenshot', 'Screenshot')
        fitem5 = self.fileMenu.Append(4, 'Copy Image', 'Copy Image')

        self.menuBar.Append(self.fileMenu, "&File")
        self.SetMenuBar(self.menuBar)

        self.Bind(wx.EVT_MENU, self.OnQuit, fitem1)
        self.Bind(wx.EVT_MENU, self.On_ToolButton_Save_Click, fitem2)
        self.Bind(wx.EVT_MENU, self.On_ToolButton_Clear_Click, fitem3)
        self.Bind(wx.EVT_MENU, self.On_ToolButton_Recopy_click, fitem4)
        self.Bind(wx.EVT_MENU, self.On_ToolButton_Copy_Click, fitem5)
    ...
    def On_ToolButton_Recopy_click(self, event):
